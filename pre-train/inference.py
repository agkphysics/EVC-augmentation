...
from reader.cv_10lang import TextMelIDLoader, TextMelIDCollate, id2ph, id2sp
...
tlist = '/home/akee511/src/seq2seq-EVC/fine-tune/reader/emotion_list/evaluation_mel_list.txt'  #seen speakers list

# use seen (tlist) or unseen list (hlist)
test_list = tlist
checkpoint_path='/home/akee511/src/seq2seq-EVC/pre-train/outdir/checkpoint_234000'
# TTS or VC task?
input_text=False
